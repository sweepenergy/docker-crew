...
module.exports = function(app) {
    ...
    app.get("/streamDataSet/:id/ts/:var_name/dataset",function(req,res){
        ...
        axios.get(sweepAPI.url + "stream/" + id + "/ts/" + var_name + "/dataset?span=1m&time_scale=1d&range_start=2021-05-06T05:00:00.000Z&range_end=2021-05-07T04:34:07.000Z&limit=&ts_type=avg", sweepAPI.config)
            .then(function(response){
                // console.log(response.data);
